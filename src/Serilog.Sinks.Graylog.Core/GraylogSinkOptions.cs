...
namespace Serilog.Sinks.Graylog.Core
{
    ...
    public abstract class GraylogSinkOptionsBase
    {
        ...
        /// <summary>
        /// Gets or sets the http client certificate path property required by the GELF if TLS client authentication is enabled. This should be *.pfx certificate generated by crt and key. If set to null, certificate will not be used.
        /// </summary>
        public string HttpClientCertificatePath { get; set; }
    }
}